...
path_print_file = "C:\\Mongta\\Printer-Python\\stage-cropped.png"
@csrf_exempt
def switch_printer_profile(request, profile_name, action):
    try:
        ...
        for printer in printers:
            ...
            if profile_name.lower() in printer[2].lower():
                ...
                if(printer[2]=="DSRX1CUT"):
                    if(action== 'stripx2'):
                        crop_image_8_images("C:\\Mongta\\Printer-Python\\image\\stripx2.png")
                        time.sleep(2)
                    ...
                    if action == 'cutx2':
                        crop_image_2_images("C:\\Mongta\\Printer-Python\\image\\cutx2.png")
                    elif action == 'cutx3':
                        crop_image_3_images("C:\\Mongta\\Printer-Python\\image\\cutx3.png")
                    elif action == 'cutx4':
                        crop_image_4_images("C:\\Mongta\\Printer-Python\\image\\cutx4.png")
                    elif action == 'cutx5':
                        crop_image_5_images("C:\\Mongta\\Printer-Python\\image\\cutx5.png")
                    elif action == 'cutx6':
                        crop_image_6_images("C:\\Mongta\\Printer-Python\\image\\cutx6.png")
